# Engine (working title)

Just a fork of the Hazel Engine from TheCherno, used for assignments for game engine development (GED) @FHTechnikumWien.

![Hazel](/Resources/Branding/Logo_Text_Light_Square.png?raw=true "Engine")
